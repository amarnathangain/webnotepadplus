...
var _e, _$t_instances, t_fn, _a;
var $t = (_a = class {
  constructor(t) {
    __privateAdd(this, _$t_instances);
  ...
  hasTrailingWhitespace(t) {
    return __privateGet(this, _e).has(M(0, t, -1));
  }
  trimStart(t) {
    let r = this.getLeadingWhitespaceCount(t);
    return t.slice(r);
  ...
  split(t, r = false) {
    let n = `[${zt([...__privateGet(this, _e)].join(""))}]+`, i = new RegExp(r ? `(${n})` : n, "u");
    return t.split(i);
  }
  ...
  dedentString(t) {
    let r = __privateMethod(this, _$t_instances, t_fn).call(this, t);
    return r === 0 ? t : t.split(`
`).map((n) => n.slice(r)).join(`
`);
  }
}, _e = new WeakMap(), _$t_instances = new WeakSet(), t_fn = function(t) {
...
function zr(e, t, r) {
  ...
  if (e.kind === "yaml" && delete t.value, e.kind === "attribute") {
    ...
    n === "style" || n === "class" || n === "srcset" && (r.fullName === "img" || r.fullName === "source") || n === "allow" && r.fullName === "iframe" || n.startsWith("on") || n.startsWith("@") || n.startsWith(":") || n.startsWith(".") || n.startsWith("#") || n.startsWith("v-") || n === "vars" && r.fullName === "style" || (n === "setup" || n === "generic") && r.fullName === "script" || n === "slot-scope" || n.startsWith("(") || n.startsWith("[") || n.startsWith("*") || n.startsWith("bind") || n.startsWith("i18n") || n.startsWith("on-") || n.startsWith("ng-") || (i == null ? void 0 : i.includes("{{")) ? delete t.value : i && (t.value = w(0, i, /'|&quot;|&apos;/gu, '"'));
  }
  if (e.kind === "docType" && (t.value = w(0, e.value.toLowerCase(), /\s+/gu, " ")), e.kind === "angularControlFlowBlock" && ((_a3 = e.parameters) == null ? void 0 : _a3.children)) for (let n of t.parameters.children) Ss.has(e.name) ? delete n.expression : n.expression = n.expression.trim();
...
function Ts() {
  ...
  return typeof t == "string" ? t === "windows" : ((_d = (_c = e.navigator) == null ? void 0 : _c.platform) == null ? void 0 : _d.startsWith("Win")) ?? ((_f = (_e3 = e.process) == null ? void 0 : _e3.platform) == null ? void 0 : _f.startsWith("win")) ?? false;
}
var bs = Ts();
function Xr(e) {
...
function Ns(e, t) {
  ...
  return (_a3 = ys(r, t.language) ?? Jr(r, t.physicalFile) ?? Jr(r, t.file) ?? Zr(r, t.physicalFile) ?? Zr(r, t.file) ?? (As == null ? void 0 : As(r, t.physicalFile))) == null ? void 0 : _a3.parsers[0];
}
var _t = Ns;
...
function sa(e) {
  ...
  function g() {
    let m = false, _, T, P, z, ne = {}, Q, ot, Ce, qe, Vt;
    for (z = 0; z < n.length; z++) Q = n[z], ot = Q[Q.length - 1], Ce = Q.substring(0, Q.length - 1), qe = parseInt(Ce, 10), Vt = parseFloat(Ce), Pn.test(Ce) && ot === "w" ? ((_ || T) && (m = true), qe === 0 ? m = true : _ = qe) : ia.test(Ce) && ot === "x" ? ((_ || T || P) && (m = true), Vt < 0 ? m = true : T = Vt) : Pn.test(Ce) && ot === "h" ? ((P || T) && (m = true), qe === 0 ? m = true : P = qe) : m = true;
    if (!m) ne.source = { value: r, startOffset: c }, _ && (ne.width = { value: _ }), T && (ne.density = { value: T }), P && (ne.height = { value: P }), p.push(ne);
...
function Rn(e, t, r) {
  let n = b(r.node), i = On(n), s = aa.filter((m) => i.some((_) => Object.prototype.hasOwnProperty.call(_, m)));
...
function ma(e, t) {
  ...
  if (n) return kt(r, t) ? [r.rawName, "=", n] : (_a3 = ha.find(({ test: i }) => i(e, t))) == null ? void 0 : _a3.print;
}
function fa(e) {
...
function pe(e) {
  var _a3;
  return ((_a3 = e.lastChild) == null ? void 0 : _a3.isTrailingSpaceSensitive) && !e.lastChild.hasTrailingSpaces && !O(vt(e.lastChild)) && !ae(e);
}
function he(e) {
...
function si(e) {
  var _a3, _b;
  return !(((_a3 = e.next) == null ? void 0 : _a3.kind) === "angularControlFlowBlock" && ((_b = ri.get(e.name)) == null ? void 0 : _b.has(e.next.name)));
}
var xa = (e) => (e == null ? void 0 : e.kind) === "angularControlFlowBlock" && (e.name === "case" || e.name === "default");
var ya = (e) => (e == null ? void 0 : e.kind) === "angularControlFlowBlock" && e.name === "default never";
function Aa(e) {
  return xa(e) && e.endSourceSpan && e.endSourceSpan.start.offset === e.endSourceSpan.end.offset;
}
function Na(e) {
  let { previous: t } = e;
  return (t == null ? void 0 : t.kind) === "angularControlFlowBlock" && !oe(t) && !si(t);
}
function ai(e, t, r) {
...
var te = class extends de {
  constructor(e, t, r, n, i, s, a, o = null, c = null, u, p) {
    ...
    this.name = e, this.attrs = t, this.directives = r, this.children = n, this.isSelfClosing = i, this.startSourceSpan = a, this.endSourceSpan = o, this.nameSpan = c, this.isVoid = u;
  }
  visit(e, t) {
...
var G = class extends de {
  constructor(e, t, r, n, i, s, a, o, c, u = null, p) {
    ...
    this.componentName = e, this.tagName = t, this.fullName = r, this.attrs = n, this.directives = i, this.children = s, this.isSelfClosing = a, this.startSourceSpan = c, this.endSourceSpan = u;
  }
  visit(e, t) {
...
var Ka = class Sr extends Oi {
  constructor(t, r) {
    ...
    t instanceof Sr ? (__super(t), this.internalState = { ...t.internalState }) : (__super(t, r), this.internalState = this.state);
  }
  advance() {
...
`) {
  ...
  _consumeElementStartTag(t) {
    ...
    if (this._peek.type === l.TAG_OPEN_END_VOID) {
      ...
      this.canSelfClose || (T == null ? void 0 : T.canSelfClose) || Pe(s) !== null || (T == null ? void 0 : T.isVoid) || this.errors.push(y.create(s, t.sourceSpan, `Only void, custom and foreign elements can be self closed "${t.parts[1]}"`));
    } else this._peek.type === l.TAG_OPEN_END && (this._advance(), o = false);
    let c = this._peek.sourceSpan.fullStart, u = new h(t.sourceSpan.start, c, t.sourceSpan.fullStart), p = new h(t.sourceSpan.start, c, t.sourceSpan.fullStart), d = new h(t.sourceSpan.start.moveBy(1), t.sourceSpan.end), g = new te(s, n, i, [], o, u, p, void 0, d, (a == null ? void 0 : a.isVoid) ?? false), m = this._getContainer(), _ = m !== null && !!(!((r = this._getTagDefinition(m)) === null || r === void 0) && r.isClosedByChild(g.name));
  ...
  _consumeAttr(t) {
    ...
    let u = o && c && new h((i == null ? void 0 : i.sourceSpan.start) ?? o.start, c, (i == null ? void 0 : i.sourceSpan.fullStart) ?? o.fullStart);
...
function Ar(e, t, r, n = {}) {
  ...
  if (i) {
    ...
    g = { ...i, kind: "frontMatter", sourceSpan: new h(_, T) };
  }
