...
var Re = (e, r, t) => (t = e != null ? El(Al(e)) : {}, xl(r || !e || !e.__esModule ? Ft(t, "default", { value: e, enumerable: true }) : t, e));
var Tr = x((gF, jn) => {
  "use strict";
  jn.exports = Bl;
  function Bl(e) {
...
var he = "line-suffix";
var de = "line-suffix-boundary";
var $ = "line";
var me = "label";
var te = "break-parent";
var Br = /* @__PURE__ */ new Set([be, ee, re, De, X, J, Q, pe, he, de, $, me, te]);
function Ol(e) {
...
function Pl(e, r, t, n) {
  ...
  for (; i.length > 0; ) {
    ...
    let a = W(u);
    if (!a) throw new Be(u);
    if ((r == null ? void 0 : r(u)) !== false) switch (a) {
      case j:
      case J: {
        let o = a === j ? u : u.parts;
...
function Ge(e, r = {}) {
  return ne(e), Or(r.expandedStates, true), { type: X, id: r.id, contents: e, break: !!r.shouldBreak, expandedStates: r.expandedStates };
}
function Zn(e, r = "", t = {}) {
...
var qr = { type: $ };
var Nr = { type: $, soft: true };
var ar = { type: $, hard: true };
var M = [ar, Ue];
var Sl = { type: $, hard: true, literal: true };
var nr = [Sl, Ue];
var Ll = "cr";
var Rl = "crlf";
var Ml = "\r";
...
var jl = { type: 0 };
var $l = { type: 1 };
var vt = { value: "", length: 0, queue: [], get root() {
  return vt;
} };
function ni(e, r, t) {
...
var ue = Symbol("MODE_FLAT");
var bt = Symbol("DOC_FILL_PRINTED_LENGTH");
...
var ci = Object.freeze({ character: '"', codePoint: 34 });
var Jl = Object.freeze({ preferred: si, alternate: ci });
var Ql = Object.freeze({ preferred: ci, alternate: si });
function Zl(e, r) {
...
var rf = Me("toReversed", function() {
  if (Array.isArray(this)) return ef;
});
var Di = rf;
function tf() {
  var _a2, _b, _c, _d, _e3, _f2;
  let e = globalThis, r = (_b = (_a2 = e.Deno) == null ? void 0 : _a2.build) == null ? void 0 : _b.os;
  return typeof r == "string" ? r === "windows" : ((_d = (_c = e.navigator) == null ? void 0 : _c.platform) == null ? void 0 : _d.startsWith("Win")) ?? ((_f2 = (_e3 = e.process) == null ? void 0 : _e3.platform) == null ? void 0 : _f2.startsWith("win")) ?? false;
}
var nf = tf();
function pi(e) {
...
var di = (e) => String(e).startsWith("file:");
function mi(e, r) {
  if (!r) return;
  let t = hi(r).toLowerCase();
  return e.find(({ filenames: n }) => n == null ? void 0 : n.some((i) => i.toLowerCase() === t)) ?? e.find(({ extensions: n }) => n == null ? void 0 : n.some((i) => t.endsWith(i)));
}
function of(e, r) {
...
function cf(e, r) {
  ...
  return (_a2 = of(t, r.language) ?? mi(t, r.physicalFile) ?? mi(t, r.file) ?? Fi(t, r.physicalFile) ?? Fi(t, r.file) ?? (sf == null ? void 0 : sf(t, r.physicalFile))) == null ? void 0 : _a2.parsers[0];
}
var wt = cf;
var Sr = Symbol.for("PRETTIER_IS_FRONT_MATTER");
function lf(e) {
  return !!(e == null ? void 0 : e[Sr]);
}
var kt = lf;
var sr = 3;
function ff(e) {
...
var Ci = /<!--\s*@(?:format|prettier)\s*-->|\{\s*\/\*\s*@(?:format|prettier)\s*\*\/\s*\}|<!--.*\r?\n[\s\S]*(^|\n)[^\S\n]*@(?:format|prettier)[^\S\n]*($|\n)[\s\S]*\n.*-->/mu;
var Lr = (e) => {
  var _a2;
  return ((_a2 = _e(e).content.trimStart().match(Ci)) == null ? void 0 : _a2.index) === 0;
};
var vi = (e) => {
  var _a2;
  return ((_a2 = _e(e).content.trimStart().match(Ei)) == null ? void 0 : _a2.index) === 0;
};
var Ai = (e) => {
...
`, " ")), e.type === "wikiLink" && (r.value = R(0, e.value.trim(), /[\t\n]+/gu, " ")), (e.type === "definition" || e.type === "linkReference" || e.type === "imageReference") && (r.label = (0, bi.default)(e.label)), (e.type === "link" || e.type === "image") && e.url && e.url.includes("(")) for (let n of "<>") r.url = R(0, e.url, n, encodeURIComponent(n));
  if ((e.type === "definition" || e.type === "link" || e.type === "image") && e.title && (r.title = R(0, e.title, /\\(?=["')])/gu, "")), (t == null ? void 0 : t.type) === "root" && t.children.length > 0 && (t.children[0] === e || kt(t.children[0]) && t.children[1] === e) && e.type === "html" && Lr(e.value)) return null;
}
...
var Oe = new RegExp("(?:[\\u{21}-\\u{2f}\\u{3a}-\\u{40}\\u{5b}-\\u{60}\\u{7b}-\\u{7e}]|\\p{General_Category=Connector_Punctuation}|\\p{General_Category=Dash_Punctuation}|\\p{General_Category=Close_Punctuation}|\\p{General_Category=Final_Punctuation}|\\p{General_Category=Initial_Punctuation}|\\p{General_Category=Other_Punctuation}|\\p{General_Category=Open_Punctuation})", "u");
var qe = (e) => e.position.start.offset;
var Ne = (e) => e.position.end.offset;
var Tt = /* @__PURE__ */ new Set(["liquidNode", "inlineCode", "emphasis", "esComment", "strong", "delete", "wikiLink", "link", "linkReference", "image", "imageReference", "footnote", "footnoteReference", "sentence", "whitespace", "word", "break", "inlineMath"]);
var Rr = /* @__PURE__ */ new Set([...Tt, "tableCell", "paragraph", "heading"]);
var We = "non-cjk";
var ae = "cj-letter";
var Pe = "k-letter";
var cr = "cjk-punctuation";
var hf = new RegExp("\\p{Script_Extensions=Hangul}", "u");
function Mr(e) {
  let r = [], t = e.split(/([\t\n ]+)/u);
...
` : " " });
  ...
  function n(i) {
    let u = U(0, r, -1);
    (u == null ? void 0 : u.type) === "word" && !a(We, cr) && ![u.value, i.value].some((o) => /\u3000/u.test(o)) && r.push({ type: "whitespace", value: "" }), r.push(i);
    function a(o, s) {
...
var _e2, __t_instances, r_fn, _a;
var _t = (_a = class {
  constructor(r) {
    __privateAdd(this, __t_instances);
    __privateAdd(this, _e2);
    __privateSet(this, _e2, new Set(r));
  }
  getLeadingWhitespaceCount(r) {
    let t = __privateGet(this, _e2), n = 0;
  ...
  hasLeadingWhitespace(r) {
    return __privateGet(this, _e2).has(r.charAt(0));
  }
  hasTrailingWhitespace(r) {
    return __privateGet(this, _e2).has(U(0, r, -1));
  }
  trimStart(r) {
    let t = this.getLeadingWhitespaceCount(r);
    return r.slice(t);
  ...
  split(r, t = false) {
    let n = `[${fe([...__privateGet(this, _e2)].join(""))}]+`, i = new RegExp(t ? `(${n})` : n, "u");
    return r.split(i);
  }
  hasWhitespaceCharacter(r) {
    let t = __privateGet(this, _e2);
  ...
  dedentString(r) {
    let t = __privateMethod(this, __t_instances, r_fn).call(this, r);
    return t === 0 ? r : r.split(`
`).map((n) => n.slice(t)).join(`
`);
  }
}, _e2 = new WeakMap(), __t_instances = new WeakSet(), r_fn = function(r) {
...
var Lf = /* @__PURE__ */ new Set(["heading", "tableCell", "link", "wikiLink"]);
var Gi = new Set("!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~");
...
function Wi(e) {
  ...
  return (r == null ? void 0 : r.type) === "sentence" && ((_a2 = U(0, r.children, -1)) == null ? void 0 : _a2.type) === "word" && !U(0, r.children, -1).hasTrailingPunctuation || (t == null ? void 0 : t.type) === "sentence" && ((_b = t.children[0]) == null ? void 0 : _b.type) === "word" && !t.children[0].hasLeadingPunctuation;
}
function Yf(e, r, t) {
  let { node: n } = e;
  if (zf(e)) {
...
var jf = { features: { experimental_frontMatterSupport: { massageAstNode: true, embed: true, print: true } }, preprocess: Ui, print: Yf, embed: Ti, massageAstNode: yi, hasPrettierIgnore: Vf, insertPragma: Ai, getVisitorKeys: Oi };
var Hi = jf;
...
var It = { bracketSpacing: { category: "Common", type: "boolean", default: true, description: "Print spaces between brackets.", oppositeDescription: "Do not print spaces between brackets." }, objectWrap: { category: "Common", type: "choice", default: "preserve", description: "How to wrap object literals.", choices: [{ value: "preserve", description: "Keep as multi-line, if there is a newline between the opening brace and first property." }, { value: "collapse", description: "Fit to a single line when possible." }] }, singleQuote: { category: "Common", type: "boolean", default: false, description: "Use single quotes instead of double quotes." }, proseWrap: { category: "Common", type: "choice", default: "preserve", description: "How to wrap prose.", choices: [{ value: "always", description: "Wrap prose if it exceeds the print width." }, { value: "never", description: "Do not wrap prose." }, { value: "preserve", description: "Wrap prose as-is." }] }, bracketSameLine: { category: "Common", type: "boolean", default: false, description: "Put > of opening tags on the last line instead of on a new line." }, singleAttributePerLine: { category: "Common", type: "boolean", default: false, description: "Enforce single attribute per line in HTML, Vue and JSX." } };
...
var Fl = { astFormat: "mdast", hasPragma: Lr, hasIgnorePragma: vi, locStart: qe, locEnd: Ne };
var cF = { ...Fl, parse: ml({ isMDX: false }) };
var lF = { ...Fl, parse: ml({ isMDX: true }) };
var fF = { mdast: Hi };
export {
  gl as default,
  Ki as languages,
...
//# sourceMappingURL=prettier_plugins_markdown.js.map
