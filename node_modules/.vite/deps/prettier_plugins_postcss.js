...
var sn = (t, e) => {
  for (var s in e) Vr(t, s, { get: e[s], enumerable: true });
};
var Al = (t, e, s, r) => {
  if (e && typeof e == "object" || typeof e == "function") for (let n of Sl(e)) !Tl.call(t, n) && n !== s && Vr(t, n, { get: () => e[n], enumerable: !(r = El(e, n)) || r.enumerable });
  return t;
};
var Te = (t, e, s) => (s = t != null ? bl(kl(t)) : {}, Al(e || !t || !t.__esModule ? Vr(s, "default", { value: t, enumerable: true }) : s, t));
var Oi = w((ux, os) => {
...
var zt = w((fx, Pi) => {
  ...
  var Ci = Oi(), Ni = as(), st = class t extends Error {
    ...
    showSourceCode(e) {
      ...
      if (e) {
        let { bold: f, gray: h, red: c } = Ci.createColors(true);
...
` ? (s = 1, r += 1) : s += 1;
  ...
  var at = class {
    ...
    constructor(e = {}) {
      this.raws = {}, this[ot] = false, this[Mc] = true;
...
var fe = w((wx, zi) => {
  ...
  function Vi(t) {
    if (t[Fi] = false, t.proxyOf.nodes) for (let e of t.proxyOf.nodes) Vi(e);
  }
  ...
  z.default = z;
  z.rebuild = (t) => {
    t.type === "atrule" ? Object.setPrototypeOf(t, fs.prototype) : t.type === "rule" ? Object.setPrototypeOf(t, ps.prototype) : t.type === "decl" ? Object.setPrototypeOf(t, Ui.prototype) : t.type === "comment" ? Object.setPrototypeOf(t, Bi.prototype) : t.type === "root" && Object.setPrototypeOf(t, Gi.prototype), t[$i] = true, t.nodes && t.nodes.forEach((e) => {
      z.rebuild(e);
    });
  };
});
...
`), s = new Array(e.length), r = 0;
  ...
  var Be = class {
    ...
    constructor(e, s = {}) {
      ...
      if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = true, this.css = this.css.slice(1)) : this.hasBOM = false, this.document = this.css, s.document && (this.document = s.document.toString()), s.from && (!Zi || /^\w+:\/\//.test(s.from) || ys(s.from) ? this.file = s.from : this.file = gs(s.from)), Zi && Hc) {
...
var ws = w((Ax, uo) => {
  "use strict";
  var pt = { comma(t) {
    return pt.split(t, [","], true);
  }, space(t) {
    let e = [" ", `
`, "	"];
    return pt.split(t, e);
  }, split(t, e, s) {
    let r = [], n = "", i = false, o = 0, u = false, a = "", l = false;
    for (let f of t) l ? l = false : f === "\\" ? l = true : u ? f === a && (u = false) : f === '"' || f === "'" ? (u = true, a = f) : f === "(" ? o += 1 : f === ")" ? o > 0 && (o -= 1) : o === 0 && e.includes(f) && (i = true), i ? (n !== "" && r.push(n.trim()), n = "", i = false) : n += f;
...
var er = w((Cx, po) => {
  ...
  po.exports = function(e, s = {}) {
    ...
    function H(W) {
      ...
      if (p >= d) return;
      let A = W ? W.ignoreUnclosed : false;
      switch (i = r.charCodeAt(p), i) {
        ...
        case 40: {
          if (b = m.length ? m.pop()[1] : "", g = r.charCodeAt(p + 1), b === "url" && g !== 39 && g !== 34 && g !== 32 && g !== 10 && g !== 9 && g !== 12 && g !== 13) {
            a = p;
            do {
              if (h = false, a = r.indexOf(")", a + 1), a === -1) if (n || A) {
                a = p;
                break;
              } else O("bracket");
        ...
        case 34: {
          l = i === 39 ? "'" : '"', a = p;
          do {
            if (h = false, a = r.indexOf(l, a + 1), a === -1) if (n || A) {
              a = p + 1;
              break;
            } else O("string");
            for (c = a; r.charCodeAt(c - 1) === 92; ) c -= 1, h = !h;
...
var tr = w((Nx, yo) => {
  "use strict";
  var Xc = Qt(), Jc = Me(), Zc = ft(), ef = $e(), ho = Xt(), tf = er(), mo = { empty: true, space: true };
  function rf(t) {
  ...
  var vs = class {
    constructor(e) {
      this.input = e, this.root = new ef(), this.current = this.root, this.spaces = "", this.semicolon = false, this.createTokenizer(), this.root.source = { input: e, start: { column: 1, line: 1, offset: 0 } };
    }
    atrule(e) {
      let s = new Xc();
      s.name = e[1].slice(1), s.name === "" && this.unnamedAtrule(s, e), this.init(s, e[2]);
      let r, n, i, o = false, u = false, a = [], l = [];
    ...
    decl(e, s) {
      ...
      this.init(r, e[0][2]);
      let n = e[e.length - 1];
      for (n[0] === ";" && (this.semicolon = true, e.pop()), r.source.end = this.getPosition(n[3] || n[2] || rf(e)), r.source.end.offset++; e[0][0] !== "word"; ) e.length === 1 && this.unknownWord(e), r.raws.before += e.shift()[1];
      ...
      for (let l = e.length - 1; l >= 0; l--) {
        if (i = e[l], i[1].toLowerCase() === "!important") {
          ...
          h.trim().startsWith("!") && (r.important = true, r.raws.important = h, e = f);
        }
    ...
    other(e) {
      let s = false, r = null, n = false, i = null, o = [], u = e[1].startsWith("--"), a = [], l = e;
      for (; l; ) {
    ...
    raw(e, s, r, n) {
      let i, o, u = r.length, a = "", l = true, f, h;
      for (let c = 0; c < u; c += 1) i = r[c], o = i[0], o === "space" && c === u - 1 && !n ? l = false : o === "comment" ? (h = r[c - 1] ? r[c - 1][0] : "empty", f = r[c + 1] ? r[c + 1][0] : "empty", !mo[h] && !mo[f] ? a.slice(-1) === "," ? l = false : a += i[1] : l = false) : a += i[1];
      if (!l) {
...
`));
      ...
      return this.inlineComment(i), n && (this.input = new uf(n), this.tokenizer = af(this.input)), true;
    } else if (t[1] === "/") {
...
var bo = w((qx, _o) => {
  var lf = /^#[0-9a-fA-F]{6}$|^#[0-9a-fA-F]{3}$/, cf = /\.[0-9]/, ff = (t) => {
    let [, e] = t, [s] = e;
    return (s === "." || s === "#") && lf.test(e) === false && cf.test(e) === false;
  };
...
var Ss = w((Hx, Yo) => {
  ...
  Yo.exports = function(e) {
    Go[e] || (Go[e] = true, typeof console < "u" && console.warn && console.warn(e));
  };
});
var As = w((Qx, Ho) => {
  "use strict";
  var qf = fe(), Lf = sr(), Df = bs(), Mf = ht(), Vo = nr(), Bf = $e(), Uf = it(), { isClean: Q, my: Ff } = Ht(), Kx = Ss(), $f = { atrule: "AtRule", comment: "Comment", decl: "Declaration", document: "Document", root: "Root", rule: "Rule" }, Wf = { AtRule: true, AtRuleExit: true, Comment: true, CommentExit: true, Declaration: true, DeclarationExit: true, Document: true, DocumentExit: true, Once: true, OnceExit: true, postcssPlugin: true, prepare: true, Root: true, RootExit: true, Rule: true, RuleExit: true }, Gf = { Once: true, postcssPlugin: true, prepare: true }, Ge = 0;
  function gt(t) {
    return typeof t == "object" && typeof t.then == "function";
  }
  function jo(t) {
    let e = false, s = $f[t.type];
  ...
  function ks(t) {
    return t[Q] = false, t.nodes && t.nodes.forEach((e) => ks(e)), t;
  }
  var Ts = {}, he = class t {
    get content() {
    ...
    constructor(e, s, r) {
      ...
      else if (s instanceof t || s instanceof Vo) n = ks(s.root), s.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = false), r.map.prev = s.map);
      else {
        let i = Mf;
    ...
    sync() {
      ...
      if (this.prepareVisitors(), this.hasListener) {
        let e = this.result.root;
        for (; !e[Q]; ) e[Q] = true, this.walkSync(e);
    ...
    visitTick(e) {
      ...
      for (; s.eventIndex < i.length; ) {
        ...
        if (s.eventIndex += 1, o === Ge) {
          r.nodes && r.nodes.length && (r[Q] = true, s.iterator = r.getIterator());
          return;
...
var ca = w((r_, la) => {
  ...
  la.exports = function(e, s = {}) {
    ...
    function H() {
      let A = 1, k = false, N = false;
      for (; A > 0; ) o += 1, r.length <= o && O("interpolation"), i = r.charCodeAt(o), c = r.charCodeAt(o + 1), k ? !N && i === k ? (k = false, N = false) : i === 92 ? N = !N : N && (N = false) : i === 39 || i === 34 ? k = i : i === 125 ? A -= 1 : i === 35 && c === 123 && (A += 1);
    }
    function ne(A) {
      if (m.length) return m.pop();
      if (d >= b) return;
      let k = A ? A.ignoreUnclosed : false;
      switch (i = r.charCodeAt(d), i) {
        ...
        case 40: {
          if (h = p.length ? p.pop()[1] : "", c = r.charCodeAt(d + 1), h === "url" && c !== 39 && c !== 34) {
            for (y = 1, f = false, o = d + 1; o <= r.length - 1; ) {
        ...
        case 39:
        case 34: {
          for (u = i, o = d, f = false; o < b && (o++, o === b && O("string"), i = r.charCodeAt(o), c = r.charCodeAt(o + 1), !(!f && i === u)); ) i === 92 ? f = !f : f ? f = false : i === 35 && c === 123 && H();
        ...
        case 92: {
          for (o = d, l = true; r.charCodeAt(o + 1) === 92; ) o += 1, l = !l;
      ...
      if (!s || n.trim() === "" || /^[#:A-Za-z-]/.test(n)) super.rule(e);
        ...
        for (let a = e.length - 1; a > 0; a--) {
          if (u = e[a], u[1] === "!important") {
            ...
            f.trim().indexOf("!") === 0 && (i.important = true, i.raws.important = f, e = l);
          }
...
var xa = w((xt) => {
  ...
  function va(t) {
    ...
    for (var f = 0; f < l.length; f++) {
      var h = l[f];
      if ((h === "'" || h === '"') && (s[n].isCalculationEnabled === true ? (s.push({ mode: "string", isCalculationEnabled: false, character: h }), n++) : s[n].mode === "string" && s[n].character === h && l[f - 1] !== "\\" && (s.pop(), n--)), h === "{" ? (s.push({ mode: "interpolation", isCalculationEnabled: true }), n++) : h === "}" && (s.pop(), n--), s[n].mode === "normal" && h === ":") {
  ...
  function Ds(t) {
    ...
    for (var u = 0; u < t.length; u++) {
      var a = t[u];
      n ? (i.value += a, (a === "{" || a === "(") && r++, (a === ")" || a === "}") && r--) : a.search(/\s/) !== -1 ? i.before += a : (a === "(" && (i.type = "media-feature-expression", r++), i.value = a, i.sourceIndex = e + u, n = true), n && r === 0 && (a === ")" || u === t.length - 1 || t[u + 1].search(/\s/) !== -1) && (["not", "only", "and"].indexOf(i.value) !== -1 && (i.type = "keyword"), i.type === "media-feature-expression" && (i.nodes = va(i.value, i.sourceIndex)), s.push(Array.isArray(i.nodes) ? new Ls.default(i) : new ga.default(i)), i = o(), n = false);
    }
    ...
    for (var e = [], s = t.css.valueOf(), r = void 0, n = void 0, i = void 0, o = void 0, u = void 0, a = void 0, l = void 0, f = void 0, h = void 0, c = void 0, g = void 0, b = s.length, d = -1, p = 1, m = 0, y = function(O, q) {
      ...
      switch (r = s.charCodeAt(m), r === _t && (d = m, p += 1), r) {
        ...
        case Vd:
          i = r === su ? "'" : '"', n = m;
          do
            for (c = false, n = s.indexOf(i, n + 1), n === -1 && y("quote", i), g = n; s.charCodeAt(g - 1) === Ws; ) g -= 1, c = !c;
          while (c);
        ...
        case em:
          ...
          break;
        case Ws:
          for (n = m, l = true; s.charCodeAt(n + 1) === Ws; ) n += 1, l = !l;
...
var du = w((Cr, hu) => {
  ...
  var Bm = function() {
    function t(e) {
      Mm(this, t), this.input = e, this.lossy = e.options.lossless === false, this.position = 0, this.root = new lm.default();
    ...
    return t.prototype.attribute = function() {
      ...
      if (o.length > 1 ? (o[0] === "" && (o[0] = true), u.attribute = this.parseValue(o[2]), u.namespace = this.parseNamespace(o[0])) : u.attribute = this.parseValue(i[0]), r = new Sm.default(u), i[2]) {
        var a = i[2].split(/(\s+i\s*?)$/), l = a[0].trim();
        r.value = this.lossy ? l : a[0], a[1] && (r.insensitive = true, this.lossy || (r.raws.insensitive = a[1])), r.quoted = l[0] === "'" || l[0] === '"', r.raws.unquoted = r.quoted ? l.slice(1, -1) : l;
      }
    ...
    for (; a < i; ) {
      switch (h = n.charCodeAt(a), h === 10 && (o = a, u += 1), h) {
        ...
        case 34:
          g = h === 39 ? "'" : '"', c = a;
          do
            for (O = false, c = n.indexOf(g, c + 1), c === -1 && ne("quote", g), q = c; n.charCodeAt(q - 1) === 92; ) q -= 1, O = !O;
          while (O);
...
var nl = w((rb, sl) => {
  ...
  sl.exports = class {
    ...
    comment() {
      ...
      this.options.loose && s.startsWith("//") && (s = s.substring(2), e = true), r = new _y({ value: s, inline: e, source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[4], column: this.currToken[5] } }, sourceIndex: this.currToken[6] }), this.newNode(r), this.position++;
    }
    error(e, s) {
...
var Oe = "line-suffix";
var Tt = "line-suffix-boundary";
var X = "line";
var At = "label";
var Ce = "break-parent";
var Ot = /* @__PURE__ */ new Set([Et, ie, Ae, St, oe, ae, me, kt, Oe, Tt, X, At, Ce]);
function Il(t) {
...
function D(t, e = {}) {
  return $(t), ye(e.expandedStates, true), { type: oe, id: e.id, contents: t, break: !!e.shouldBreak, expandedStates: e.expandedStates };
}
function Ct(t, e = "", s = {}) {
...
var C = { type: X };
var M = { type: X, soft: true };
var Ul = { type: X, hard: true };
var T = [Ul, Ne];
function ln(t) {
...
var fn = Object.freeze({ character: '"', codePoint: 34 });
var Wl = Object.freeze({ preferred: cn, alternate: fn });
var Gl = Object.freeze({ preferred: fn, alternate: cn });
function Yl(t, e) {
  let { preferred: s, alternate: r } = e === true || e === "'" ? Wl : Gl, { length: n } = t, i = 0, o = 0;
  for (let u = 0; u < n; u++) {
...
var ge = Ql;
var Xl = /* @__PURE__ */ new Set(["raw", "raws", "sourceIndex", "source", "before", "after", "trailingComma", "spaces"]);
function mn(t, e, s) {
...
var vn = ec;
var _ = [[], ["nodes"], ["group"]];
var xn = { "css-root": ["frontMatter", "nodes"], "css-comment": _[0], "css-rule": ["selector", "nodes"], "css-decl": ["value", "selector", "nodes"], "css-atrule": ["selector", "params", "value", "nodes"], "media-query-list": _[1], "media-query": _[1], "media-type": _[0], "media-feature-expression": _[1], "media-feature": _[0], "media-colon": _[0], "media-value": _[0], "media-keyword": _[0], "media-url": _[0], "media-unknown": _[0], "selector-root": _[1], "selector-selector": _[1], "selector-comment": _[0], "selector-string": _[0], "selector-tag": _[0], "selector-id": _[0], "selector-class": _[0], "selector-attribute": _[0], "selector-combinator": _[1], "selector-universal": _[0], "selector-pseudo": _[1], "selector-nesting": _[0], "selector-unknown": _[0], "value-value": _[2], "value-root": _[2], "value-comment": _[0], "value-comma_group": ["groups"], "value-paren_group": ["open", "groups", "close"], "value-func": _[2], "value-paren": _[0], "value-number": _[0], "value-operator": _[0], "value-word": _[0], "value-colon": _[0], "value-comma": _[0], "value-string": _[0], "value-atword": _[0], "value-unicode-range": _[0], "value-unknown": _[0] };
var tc = vn(xn);
var _n = tc;
function rc(t, e) {
  let s = 0;
...
function Sn(t, e) {
  var _a2, _b, _c2;
  if (typeof ((_b = (_a2 = t.source) == null ? void 0 : _a2.start) == null ? void 0 : _b.offset) == "number") return t.source.start.offset;
  if (typeof t.sourceIndex == "number") return t.type === "value-word" ? En(t, t.sourceIndex) : t.sourceIndex;
  if ((_c2 = t.source) == null ? void 0 : _c2.start) return Kr(t.source.start, e);
  throw Object.assign(new Error("Can not locate node."), { node: t });
}
function Qr(t, e) {
  var _a2, _b;
  if (t.type === "css-comment" && t.inline) return qt(e, t.source.startOffset);
  if (typeof ((_b = (_a2 = t.source) == null ? void 0 : _a2.end) == null ? void 0 : _b.offset) == "number") return t.source.end.offset;
  if (t.source) {
    if (t.source.end) {
...
function sc(t) {
  ...
  return typeof t.prop == "string" && (e += t.prop.length), t.type === "css-atrule" && typeof t.name == "string" && (e += 1 + t.name.length + t.raws.afterName.match(/^\s*:?\s*/u)[0].length), t.type !== "css-atrule" && typeof ((_a2 = t.raws) == null ? void 0 : _a2.between) == "string" && (e += t.raws.between.length), e;
}
function Tn(t) {
...
var P = (t) => {
  var _a2;
  return (_a2 = t.source) == null ? void 0 : _a2.startOffset;
};
var R = (t) => {
  var _a2;
  return (_a2 = t.source) == null ? void 0 : _a2.endOffset;
};
var nc = /\*\/$/;
var ic = /^\/\*\*?/;
var Nn = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/;
...
function In(t) {
  var _a2;
  let s = (_a2 = t.match(Nn)) == null ? void 0 : _a2[0];
...
var cc = /* @__PURE__ */ new Set(["red", "green", "blue", "alpha", "a", "rgb", "hue", "h", "saturation", "s", "lightness", "l", "whiteness", "w", "blackness", "b", "tint", "shade", "blend", "blenda", "contrast", "hsl", "hsla", "hwb", "hwba"]);
function zn(t) {
  var _a2, _b;
  return (_b = (_a2 = t.findAncestor((e) => e.type === "css-decl")) == null ? void 0 : _a2.prop) == null ? void 0 : _b.toLowerCase();
}
var fc = /* @__PURE__ */ new Set(["initial", "inherit", "unset", "revert"]);
function jn(t) {
  return fc.has(t.toLowerCase());
}
function Hn(t, e) {
  var _a2, _b;
  return ((_b = (_a2 = t.findAncestor((r) => r.type === "css-atrule")) == null ? void 0 : _a2.name) == null ? void 0 : _b.toLowerCase().endsWith("keyframes")) && ["from", "to"].includes(e.toLowerCase());
}
function Ie(t) {
...
function qe(t, e) {
  var _a2, _b;
  return ((_b = (_a2 = t.findAncestor((r) => r.type === "value-func")) == null ? void 0 : _a2.value) == null ? void 0 : _b.toLowerCase()) === e;
}
function Kn(t) {
  return t.hasAncestor((e) => {
    var _a2;
    if (e.type !== "css-rule") return false;
    let s = (_a2 = e.raws) == null ? void 0 : _a2.selector;
...
function Qn(t) {
  var _a2, _b;
  let { node: e } = t;
  return ((_a2 = e.groups[0]) == null ? void 0 : _a2.value) === "url" && e.groups.length === 2 && ((_b = t.findAncestor((s) => s.type === "css-atrule")) == null ? void 0 : _b.name) === "import";
}
function Xn(t) {
...
function ve(t) {
  return (t == null ? void 0 : t.type) === "value-operator" && t.value === "/";
}
function J(t) {
  return t.type === "value-operator" && t.value === "+";
}
...
function es(t) {
  var _a2;
  return ((_a2 = t.raws) == null ? void 0 : _a2.params) && /^\(\s*\)$/u.test(t.raws.params);
}
function Mt(t) {
...
function ai(t) {
  var _a2, _b;
  return ((_a2 = t.value) == null ? void 0 : _a2.type) === "value-root" && ((_b = t.value.group) == null ? void 0 : _b.type) === "value-value" && t.prop.toLowerCase() === "composes";
}
function ui(t) {
  var _a2, _b, _c2;
  return ((_c2 = (_b = (_a2 = t.value) == null ? void 0 : _a2.group) == null ? void 0 : _b.group) == null ? void 0 : _c2.type) === "value-paren_group" && t.value.group.group.open !== null && t.value.group.group.close !== null;
}
function Z(t) {
  var _a2;
  return ((_a2 = t == null ? void 0 : t.raws) == null ? void 0 : _a2.before) === "";
}
function Bt(t) {
  var _a2, _b;
  return t.type === "value-comma_group" && ((_b = (_a2 = t.groups) == null ? void 0 : _a2[1]) == null ? void 0 : _b.type) === "value-colon";
}
function Zr(t) {
  var _a2;
  return t.type === "value-paren_group" && ((_a2 = t.groups) == null ? void 0 : _a2[0]) && Bt(t.groups[0]);
}
function ts(t, e) {
  var _a2, _b;
  ...
  let n = t.grandparent;
  return !Zr(s) && !(n && Zr(n)) ? false : !!(((_b = (_a2 = t.findAncestor((o) => o.type === "css-decl")) == null ? void 0 : _a2.prop) == null ? void 0 : _b.startsWith("$")) || Zr(n) || n.type === "value-func");
}
function Ze(t) {
...
function li(t, e) {
  ...
  return r === -1 ? false : $t(s[r + 1]);
}
function ci(t) {
  return t.value && ["not", "and", "or"].includes(t.value.toLowerCase());
}
function fi(t) {
  return t.type !== "value-func" ? false : cc.has(t.value.toLowerCase());
}
function Le(t) {
...
function pi(t, e) {
  var _a2, _b;
  if (((_a2 = t.open) == null ? void 0 : _a2.value) !== "(" || ((_b = t.close) == null ? void 0 : _b.value) !== ")" || t.groups.some((s) => s.type !== "value-comma_group")) return false;
  if (e.type === "value-comma_group") {
    let s = e.groups.indexOf(t) - 1, r = e.groups[s];
    if ((r == null ? void 0 : r.type) === "value-word" && r.value === "with") return true;
  }
  return false;
}
function rt(t) {
  var _a2, _b;
  return t.type === "value-paren_group" && ((_a2 = t.open) == null ? void 0 : _a2.value) === "(" && ((_b = t.close) == null ? void 0 : _b.value) === ")";
}
function hc(t, e, s) {
  var _a2;
  let { node: r } = t, n = t.parent, i = t.grandparent, o = zn(t), u = o && n.type === "value-value" && (o === "grid" || o.startsWith("grid-template")), a = t.findAncestor((p) => p.type === "css-atrule"), l = a && Je(a, e), f = r.groups.some((p) => Ze(p)), h = t.map(s, "groups"), c = [""], g = qe(t, "url"), b = false, d = false;
  for (let p = 0; p < r.groups.length; ++p) {
    ...
    if (y.type === "value-string" && y.quoted) {
      ...
      k !== -1 && N !== -1 ? b = k > N : k !== -1 ? b = true : N !== -1 && (b = false);
    }
    if (b || $t(y) || $t(v) || y.type === "value-atword" && (y.value === "" || y.value.endsWith("[")) || v.type === "value-word" && v.value.startsWith("]") || y.value === "~" || e.parser === "less" && ((v == null ? void 0 : v.type) === "value-word" && v.value === "[" || y.type === "value-word" && y.value === "[" && ((v == null ? void 0 : v.type) === "value-atword" || (v == null ? void 0 : v.type) === "value-word") || y.type === "value-word" && y.value === "][" && (v == null ? void 0 : v.type) === "value-word") || y.type !== "value-string" && y.value && y.value.includes("\\") && v && v.type !== "value-comment" || (m == null ? void 0 : m.value) && m.value.indexOf("\\") === m.value.length - 1 && y.type === "value-operator" && y.value === "/" || y.value === "\\" || oi(y, v) || Ut(y) || rs(y) || Ft(v) || rs(v) && Z(v) || Ft(y) && Z(v) || y.value === "--" && Ut(v)) continue;
    let q = Dt(y), H = Dt(v);
    ...
    let W = (O == null ? void 0 : O.type) === "value-func" || O && et(O) || y.type === "value-func" || et(y), A = v.type === "value-func" || et(v) || (m == null ? void 0 : m.type) === "value-func" || m && et(m);
    if (!(!(Lt(v) || Lt(y)) && !qe(t, "calc") && !ne && (ve(v) && !W || ve(y) && !A || J(v) && !W || J(y) && !A || xe(v) || xe(y)) && (Z(v) || q && (!m || m && Dt(m)))) && !((e.parser === "scss" || e.parser === "less") && q && y.value === "-" && rt(v) && R(y) === P(v.open) && v.open.value === "(")) {
      ...
      if (u) {
        y.source && v.source && y.source.start.line !== v.source.start.line ? (c.push(T, ""), d = true) : c.push([c.pop(), " "]);
        continue;
      }
      if (!(o && (o === "font" || o.startsWith("--")) && (ve(v) && Z(v) && hi(y) || ve(y) && Z(y) && hi(m)))) {
        ...
        if ((v == null ? void 0 : v.value) !== "..." && !(tt(y) && tt(v) && R(y) === P(v))) {
          ...
          if (!(((_a2 = y.value) == null ? void 0 : _a2.endsWith("#")) && v.value === "{" && rt(v.group)) && !(Ze(v) && !O)) {
...
function hi(t) {
  if ((t == null ? void 0 : t.type) === "value-number") return true;
  if ((t == null ? void 0 : t.type) !== "value-func") return false;
...
var mi = dc;
var Wt = /* @__PURE__ */ new Map([["em", "em"], ["rem", "rem"], ["ex", "ex"], ["rex", "rex"], ["cap", "cap"], ["rcap", "rcap"], ["ch", "ch"], ["rch", "rch"], ["ic", "ic"], ["ric", "ric"], ["lh", "lh"], ["rlh", "rlh"], ["vw", "vw"], ["svw", "svw"], ["lvw", "lvw"], ["dvw", "dvw"], ["vh", "vh"], ["svh", "svh"], ["lvh", "lvh"], ["dvh", "dvh"], ["vi", "vi"], ["svi", "svi"], ["lvi", "lvi"], ["dvi", "dvi"], ["vb", "vb"], ["svb", "svb"], ["lvb", "lvb"], ["dvb", "dvb"], ["vmin", "vmin"], ["svmin", "svmin"], ["lvmin", "lvmin"], ["dvmin", "dvmin"], ["vmax", "vmax"], ["svmax", "svmax"], ["lvmax", "lvmax"], ["dvmax", "dvmax"], ["cm", "cm"], ["mm", "mm"], ["q", "Q"], ["in", "in"], ["pt", "pt"], ["pc", "pc"], ["px", "px"], ["deg", "deg"], ["grad", "grad"], ["rad", "rad"], ["turn", "turn"], ["s", "s"], ["ms", "ms"], ["hz", "Hz"], ["khz", "kHz"], ["dpi", "dpi"], ["dpcm", "dpcm"], ["dppx", "dppx"], ["x", "x"], ["cqw", "cqw"], ["cqh", "cqh"], ["cqi", "cqi"], ["cqb", "cqb"], ["cqmin", "cqmin"], ["cqmax", "cqmax"], ["fr", "fr"]]);
function ss(t) {
  let e = t.toLowerCase();
  return Wt.has(e) ? Wt.get(e) : t;
}
var yi = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu;
var mc = /(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu;
var yc = /[a-z]+/giu;
var gc = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu;
var wc = new RegExp(yi.source + `|(${gc.source})?(${mc.source})(${yc.source})?`, "giu");
function V(t, e) {
...
` || t === "\r" || t === "\u2028" || t === "\u2029";
function vc(t, e, s) {
  let r = !!(s == null ? void 0 : s.backwards);
...
var xi = _c;
function bc(t, e) {
  return e === false ? false : t.charAt(e) === "/" && t.charAt(e + 1) === "/" ? qt(t, e) : e;
}
var _i = bc;
function Ec(t, e) {
  let s = null, r = e;
  for (; r !== s; ) s = r, r = bn(t, r), r = xi(t, r), r = It(t, r);
  return r = _i(t, r), r = Gt(t, r), r !== false && Yt(t, r);
}
var Vt = Ec;
...
function bi(t, e, s) {
  ...
  let o = t.map(({ node: g, isLast: b, index: d }) => {
    var _a2;
    let p = i[d];
    Bt(g) && g.type === "value-comma_group" && g.groups && g.groups[0].type !== "value-paren_group" && ((_a2 = g.groups[2]) == null ? void 0 : _a2.type) === "value-paren_group" && ue(p) === oe && ue(p.contents) === ie && ue(p.contents.contents) === ae && (p = D(le(p)));
    let m = [p, b ? kc(t, e) : ","];
...
function Oc(t, e, s) {
  ...
  return t.each(() => {
    ...
    let { next: o } = t;
    o.type === "css-comment" && !Yt(e.originalText, P(o), { backwards: true }) && !Re(n) || o.type === "css-atrule" && o.name === "else" && n.type !== "css-comment" ? r.push(" ") : (r.push(e.__isHTMLStyleAttribute ? C : T), Vt(e.originalText, R(n)) && !Re(n) && r.push(T));
  }, "nodes"), r;
}
var De = Oc;
function Cc(t, e, s) {
  ...
  switch (r.type) {
    ...
    case "css-rule":
      return [s("selector"), r.important ? " !important" : "", r.nodes ? [((_a2 = r.selector) == null ? void 0 : _a2.type) === "selector-unknown" && Le(r.selector.value) ? C : r.selector ? " " : "", "{", r.nodes.length > 0 ? L([T, De(t, e, s)]) : "", T, "}", Zn(r) ? ";" : ""] : ";"];
    case "css-decl": {
    ...
    case "css-atrule": {
      ...
      let o = r.name === "import" && ((_b = r.params) == null ? void 0 : _b.type) === "value-unknown" && r.params.value.endsWith(";");
    ...
    case "selector-string":
      return V(r.value, e);
    case "selector-tag":
      return [r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", ((_c2 = t.previous) == null ? void 0 : _c2.type) === "selector-nesting" ? r.value : _e(Hn(t, r.value) ? r.value.toLowerCase() : r.value)];
    case "selector-id":
      return ["#", r.value];
    case "selector-class":
      return [".", _e(V(r.value, e))];
    case "selector-attribute":
      return ["[", r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", r.attribute.trim(), r.operator ?? "", r.value ? gi(V(r.value.trim(), e), e) : "", r.insensitive ? " i" : "", "]"];
    ...
    case "selector-unknown": {
      if ((_d = t.findAncestor((u) => u.type === "css-rule")) == null ? void 0 : _d.isSCSSNesterProperty) return _e(V(Ie(r.value), e));
      let i = t.parent;
      if ((_e2 = i.raws) == null ? void 0 : _e2.selector) {
        let u = P(i), a = u + i.raws.selector.length;
        return e.originalText.slice(u, a).trim();
      }
      let o = t.grandparent;
      if (i.type === "value-paren_group" && (o == null ? void 0 : o.type) === "value-func" && o.value === "selector") {
    ...
    case "value-colon": {
      let { previous: n } = t;
      return D([r.value, typeof (n == null ? void 0 : n.value) == "string" && n.value.endsWith("\\") || qe(t, "url") ? "" : C]);
    }
    case "value-string":
...
function By(t, e) {
  ...
  for (let a = 0; a < s.length; ++a) {
    ...
    if (e.parser === "scss" && l.type === "number" && l.unit === ".." && l.value.endsWith(".") && (l.value = l.value.slice(0, -1), l.unit = "..."), l.type === "func" && l.value === "selector" && (l.group.groups = [se(Gr(t).text.slice(l.group.open.sourceIndex + 1, l.group.close.sourceIndex))]), l.type === "func" && l.value === "url") {
      let f = ((_a2 = l.group) == null ? void 0 : _a2.groups) ?? [], h = [];
...
function Uy(t, e) {
  ...
  let s = null;
  try {
    s = new cl.default(t, { loose: true }).parse();
  } catch {
...
var de = Uy;
var Fy = /* @__PURE__ */ new Set(["import", "use", "forward"]);
function $y(t) {
  return Fy.has(t);
}
var pl = $y;
  ...
  if (Se(t)) {
    ...
    if (t.raws ?? (t.raws = {}), t.type === "css-decl" && typeof t.prop == "string" && t.prop.startsWith("--") && typeof t.value == "string" && t.value.startsWith("{")) {
      ...
      if (t.value.trimEnd().endsWith("}")) {
        ...
        ((_a2 = f == null ? void 0 : f.nodes) == null ? void 0 : _a2.length) === 1 && f.nodes[0].type === "css-rule" && (i = f.nodes[0].nodes);
      }
    ...
    if (e.parser === "less" && t.type === "css-decl" && r.startsWith("extend(") && (t.extend || (t.extend = t.raws.between === ":"), t.extend && !t.selector && (delete t.value, t.selector = se(r.slice(7, -1)))), t.type === "css-atrule") {
      ...
      if (e.parser === "less") {
        ...
        if (!["page", "nest", "keyframes"].includes(t.name) && ((_b = t.params) == null ? void 0 : _b[0]) === ":") {
          t.variable = true;
...
var Zs = { astFormat: "postcss", hasPragma: Gn, hasIgnorePragma: Yn, locStart: P, locEnd: R };
var Vy = { ...Zs, parse: wl };
var zy = { ...Zs, parse: vl };
var jy = { ...Zs, parse: xl };
var Hy = { postcss: Ei };
...
//# sourceMappingURL=prettier_plugins_postcss.js.map
