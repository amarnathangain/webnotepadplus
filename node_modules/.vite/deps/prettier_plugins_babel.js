...
var Re = (a2, t) => {
  for (var e in t) Hs(a2, e, { get: t[e], enumerable: true });
};
var Ks = {};
Re(Ks, { parsers: () => ra });
var kt = {};
...
var Ft = (a2, t) => {
  a2 && ri(a2, t, { enumerable: false, value: a2[t] });
};
function ne(a2) {
  return Ft(a2.loc.start, "index"), Ft(a2.loc.end, "index"), a2;
}
var ai = (a2) => class extends a2 {
  parse() {
...
var gt = [];
function P(a2, t = {}) {
  return ++pe, mt.push(a2), yt.push(t.binop ?? -1), xt.push(t.beforeExpr ?? false), Pt.push(t.startsExpr ?? false), gt.push(t.prefix ?? false), dt.push(new we(a2, t)), pe;
}
function b(a2, t = {}) {
  return ++pe, ft.set(a2, pe), mt.push(a2), yt.push(t.binop ?? -1), xt.push(t.beforeExpr ?? false), Pt.push(t.startsExpr ?? false), gt.push(t.prefix ?? false), dt.push(new we("name", t)), pe;
}
...
function B(a2) {
  return a2 < 65 ? a2 === 36 : a2 <= 90 ? true : a2 < 97 ? a2 === 95 : a2 <= 122 ? true : a2 <= 65535 ? a2 >= 170 && Pi.test(String.fromCharCode(a2)) : Ke(a2, Yt);
}
function K(a2) {
  return a2 < 48 ? a2 === 36 : a2 < 58 ? true : a2 < 65 ? false : a2 <= 90 ? true : a2 < 97 ? a2 === 95 : a2 <= 122 ? true : a2 <= 65535 ? a2 >= 170 && gi.test(String.fromCharCode(a2)) : Ke(a2, Yt) || Ke(a2, Ti);
}
...
function Ut(a2, t, e) {
  for (let s = t; s < e; s++) if (G(a2.charCodeAt(s))) return true;
  return false;
}
var _e = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g;
var je = /(?:[^\S\n\r\u2028\u2029]|\/\/.*|\/\*.*?\*\/)*/g;
...
function rs(a2, t, e, s, i, r) {
  ...
  if (n === 123) {
    if (++t, { code: o, pos: t } = et(a2, t, e, s, a2.indexOf("}", t) - t, true, i, r), ++t, o !== null && o > 1114111) if (i) r.invalidCodePoint(t, e, s);
    else return { code: null, pos: t };
  } else ({ code: o, pos: t } = et(a2, t, e, s, 4, false, i, r));
  return { code: o, pos: t };
}
function he(a2, t, e) {
...
function lt(a2) {
  var _a;
  if ((_a = a2.extra) == null ? void 0 : _a.parenthesized) return false;
  switch (a2.type) {
    case "Identifier":
      return true;
    case "MemberExpression":
...
var pt = class extends ct {
  ...
  parseHackPipeBody() {
    ...
    return Qs.has(e.type) && !((_a = e.extra) == null ? void 0 : _a.parenthesized) && this.raise(p.PipeUnparenthesizedBody, t, { type: e.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(p.PipeTopicUnused, t), e;
  }
...
var ve = pr;
var ee = (a2, t) => (e, s, ...i) => e | 1 && s == null ? void 0 : (t.call(s) ?? s[a2]).apply(s, i);
...
function M(a2) {
  var _a, _b, _c;
  let t = ((_a = a2.range) == null ? void 0 : _a[0]) ?? a2.start, e = (_c = ((_b = a2.declaration) == null ? void 0 : _b.decorators) ?? a2.decorators) == null ? void 0 : _c[0];
  return e ? Math.min(M(e), t) : t;
}
function L(a2) {
  var _a;
  return ((_a = a2.range) == null ? void 0 : _a[1]) ?? a2.end;
}
function yr(a2) {
  let t = new Set(a2);
